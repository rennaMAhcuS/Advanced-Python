...
class Entity(pygame.sprite.Sprite):
    ...
    def get_state(self):
        ...
        return str(self.facing_direction) + str('' if moving else '_idle')
...
class Character(Entity):
    def __init__(self, pos, frames, groups, facing_direction, character_data, player, create_dialog, collision_sprites,
        ...
        self.nurse = nurse
        self.monsters = {i: Monster(name, lvl) for i, (name, lvl) in
                         character_data['monsters'].items()} if 'monsters' in character_data else None
    ...
    def get_dialog(self):
        return self.character_data['dialog'][str('defeated' if self.character_data['defeated'] else 'default')]
